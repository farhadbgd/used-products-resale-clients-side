...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content my-5">
                <div>
                    ...
                    <p style={{ fontSize: '20px', color: 'orange', fontWeight: 'bold' }}>Book World</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div className="flex justify-center gap-4 md:place-self-center md:justify-self-end">
